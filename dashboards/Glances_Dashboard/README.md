...
🚀 Powerful Server Monitoring Dashboard for Home Assistant using **Glances + Docker + Portainer + YAML + HACS**.
...
While using Frigate during heavy rain, Frigate started detecting every rain drop as a person 😄
